      ...
      <section className="services" id="services">
        <div className="container">
          ...
          <div className="service-grid-15">
            <Link href="/services/architectural-design" className="grid-tile reveal">
              <span className="tile-icon">🏗️</span>
              <h3>Architectural Design</h3>
            </Link>
            <Link href="/services/structural-engineering" className="grid-tile reveal delay-1">
              <span className="tile-icon">🧱</span>
              <h3>Structural Engineering</h3>
            </Link>
            <Link href="/services/mep-engineering" className="grid-tile reveal delay-2">
              <span className="tile-icon">⚙️</span>
              <h3>MEP Engineering</h3>
            </Link>
            <Link href="/services/bim-services" className="grid-tile reveal">
              <span className="tile-icon">🏢</span>
              <h3>BIM Services</h3>
            </Link>
            <Link href="/services/construction-documentation" className="grid-tile reveal delay-1">
              <span className="tile-icon">📄</span>
              <h3>Construction Docs</h3>
            </Link>
            <Link href="/services/quantity-surveying" className="grid-tile reveal delay-2">
              <span className="tile-icon">💰</span>
              <h3>Quantity Surveying</h3>
            </Link>
            <Link href="/services/project-planning" className="grid-tile reveal">
              <span className="tile-icon">📅</span>
              <h3>Project Planning</h3>
            </Link>
            <Link href="/services/3d-visualization" className="grid-tile reveal delay-1">
              <span className="tile-icon">🎥</span>
              <h3>3D Visualization</h3>
            </Link>
            <Link href="/services/gis-land-survey" className="grid-tile reveal delay-2">
              <span className="tile-icon">🌍</span>
              <h3>GIS & Survey</h3>
            </Link>
            <Link href="/services/construction-it" className="grid-tile reveal">
              <span className="tile-icon">💻</span>
              <h3>Construction IT</h3>
            </Link>
            <Link href="/services/administrative-back-office" className="grid-tile reveal delay-1">
              <span className="tile-icon">📊</span>
              <h3>Admin & Back Office</h3>
            </Link>
            <Link href="/services/procurement-support" className="grid-tile reveal delay-2">
              <span className="tile-icon">📦</span>
              <h3>Procurement Support</h3>
            </Link>
            <Link href="/services/compliance-documentation" className="grid-tile reveal">
              <span className="tile-icon">⚖️</span>
              <h3>Compliance & Docs</h3>
            </Link>
            <Link href="/services/marketing-digital" className="grid-tile reveal delay-1">
              <span className="tile-icon">🌐</span>
              <h3>Digital Presence</h3>
            </Link>
            <Link href="/services/ai-automation-data" className="grid-tile reveal delay-2">
              <span className="tile-icon">🤖</span>
              <h3>AI & Automation</h3>
            </Link>
          </div>
